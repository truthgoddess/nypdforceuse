...
router.get('/allYear/allQuarter/allDuty/allCommand', async function (
  ...
  try {
    console.log(
      'api/graphData/incidentsBasisEncounter/allYear/allQuarter/allDuty/allCommand route'
    )
  } catch (error) {
    next(error)
  }
...
router.get('allYear/AllQuarter/allDuty/:command', async function (
  ...
  try {
    console.log(
      'api/graphData/incidentsBasisEncounter/allYear/AllQuarter/allDuty/:command route'
    )
  } catch (error) {
    next(error)
  }
...
router.get('/allYear/allQuarter/:duty/allCommand', async function (
  ...
  try {
    console.log(
      'api/graphData/incidentsBasisEncounter/allYear/allQuarter/:duty/allCommand route'
    )
  } catch (error) {
    next(error)
  }
...
router.get('/allYear/allQuarter/:duty/:command', async function (
  ...
  try {
    console.log(
      'api/graphData/incidentsBasisEncounter/allYear/allQuarter/:duty/:command route'
    )
  } catch (error) {
    next(error)
  }
...
router.get('/allYear/:quarter/allDuty/allCommand/', async function (
  ...
  try {
    console.log(
      'api/graphData/incidentsBasisEncounter/allYear/:quarter/allDuty/allCommand/ route'
    )
  } catch (error) {
    next(error)
  }
...
router.get('/allYear/:quarter/allDuty/:command', async function (
  ...
  try {
    console.log(
      'api/graphData/incidentsBasisEncounter/allYear/:quarter/allDuty/:command route'
    )
  } catch (error) {
    next(error)
  }
...
router.get('allYear/:quarter/:duty/allCommand', async function (
  ...
  try {
    console.log(
      'api/graphData/incidentsBasisEncounter/allYear/:quarter/:duty/allCommand route'
    )
  } catch (error) {
    next(error)
  }
...
router.get('/allYear/:quarter/:duty/:command', async function (req, res, next) {
  try {
    console.log(
      'api/graphData/incidentsBasisEncounter/allYear/:quarter/:duty/:command'
    )
  } catch (error) {
    next(error)
  }
...
router.get('/:year/allQuarter/allDuty/allCommand', async function (
  ...
  try {
    console.log(
      'api/graphData/incidentsBasisEncounter/:year/allQuarter/allDuty/allCommand route'
    )
  } catch (error) {
    next(error)
  }
...
router.get('/:year/allQuarter/allDuty/:command', async function (
  ...
  try {
    console.log(
      'api/graphData/incidentsBasisEncounter/:year/allQuarter/allDuty/:command'
    )
  } catch (error) {
    next(error)
  }
...
router.get('/:year/allQuarter/:duty/allCommand', async function (
  ...
  try {
    console.log(
      'api/graphData/incidentsBasisEncounter/:year/allQuarter/:duty/allCommand'
    )
  } catch (error) {
    next(error)
  }
...
router.get('/:year/allQuarter/:duty/:command', async function (req, res, next) {
  try {
    console.log(
      'api/graphData/incidentsBasisEncounter/:year/allQuarter/:duty/:command'
    )
  } catch (error) {
    next(error)
  }
...
router.get('/:year/:quarter/allDuty/allCommand', async function (
  ...
  try {
    console.log(
      'api/graphData/incidentsBasisEncounter/:year/:quarter/allDuty/allCommand'
    )
  } catch (error) {
    next(error)
  }
...
router.get('/:year/:quarter/allDuty/:command', async function (req, res, next) {
  try {
    console.log(
      'api/graphData/incidentsBasisEncounter/:year/:quarter/allDuty/:command'
    )
  } catch (error) {
    next(error)
  }
...
router.get('/:year/:quarter/:duty/allCommand', async function (req, res, next) {
  try {
    console.log(
      'api/graphData/incidentsBasisEncounter/:year/:quarter/:duty/allCommand'
    )
  } catch (error) {
    next(error)
  }
...
router.get('/:year/:quarter/:duty/:command', async function (req, res, next) {
  try {
    console.log(
      'api/graphData/incidentsBasisEncounter/:year/:quarter/:duty/:command'
    )
  } catch (error) {
    next(error)
  }
