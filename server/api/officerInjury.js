...
router.get('/allYear/allQuarter/allDuty/allCommand', async function (
  ...
  try {
    ...
    console.log(
      'api/graphData/officerInjury/allYear/allQuarter/allDuty/allCommand route'
    )
  } catch (error) {
    next(error)
  }
...
router.get('/allYear/AllQuarter/allDuty/:command', async function (
  ...
  try {
    ...
    console.log(
      'api/graphData/officerInjury/allYear/AllQuarter/allDuty/:command route'
    )
  } catch (error) {
    next(error)
  }
...
router.get('/allYear/allQuarter/:duty/allCommand', async function (
  ...
  try {
    ...
    console.log(
      'api/graphData/officerInjury/allYear/allQuarter/:duty/allCommand route'
    )
  } catch (error) {
    next(error)
  }
...
router.get('/allYear/allQuarter/:duty/:command', async function (
  ...
  try {
    ...
    console.log(
      'api/graphData/officerInjury/allYear/allQuarter/:duty/:command route'
    )
  } catch (error) {
    next(error)
  }
...
router.get('/allYear/:quarter/allDuty/allCommand/', async function (
  ...
  try {
    ...
    console.log(
      'api/graphData/officerInjury/allYear/:quarter/allDuty/allCommand/ route'
    )
  } catch (error) {
    next(error)
  }
...
router.get('/allYear/:quarter/allDuty/:command', async function (
  ...
  try {
    ...
    console.log(
      'api/graphData/officerInjury/allYear/:quarter/allDuty/:command route'
    )
  } catch (error) {
    next(error)
  }
...
router.get('/allYear/:quarter/:duty/allCommand', async function (
  ...
  try {
    ...
    console.log(
      'api/graphData/officerInjury/allYear/:quarter/:duty/allCommand route'
    )
  } catch (error) {
    next(error)
  }
...
router.get('/allYear/:quarter/:duty/:command', async function (req, res, next) {
  try {
    ...
    console.log('api/graphData/officerInjury/allYear/:quarter/:duty/:command')
  } catch (error) {
    next(error)
  }
})
...
router.get('/:year/allQuarter/allDuty/allCommand', async function (
  ...
  try {
    ...
    console.log(
      'api/graphData/officerInjury/:year/allQuarter/allDuty/allCommand route'
    )
  } catch (error) {
    next(error)
  }
...
router.get('/:year/allQuarter/allDuty/:command', async function (
  ...
  try {
    ...
    console.log('api/graphData/officerInjury/:year/allQuarter/allDuty/:command')
  } catch (error) {
    next(error)
  }
})
...
router.get('/:year/allQuarter/:duty/allCommand', async function (
  ...
  try {
    ...
    console.log('api/graphData/officerInjury/:year/allQuarter/:duty/allCommand')
  } catch (error) {
    next(error)
  }
})
...
router.get('/:year/allQuarter/:duty/:command', async function (req, res, next) {
  try {
    ...
    console.log('api/graphData/officerInjury/:year/allQuarter/:duty/:command')
  } catch (error) {
    next(error)
  }
})
...
router.get('/:year/:quarter/allDuty/allCommand', async function (
  ...
  try {
    ...
    console.log('api/graphData/officerInjury/:year/:quarter/allDuty/allCommand')
  } catch (error) {
    next(error)
  }
})
...
router.get('/:year/:quarter/allDuty/:command', async function (req, res, next) {
  try {
    ...
    console.log('api/graphData/officerInjury/:year/:quarter/allDuty/:command')
  } catch (error) {
    next(error)
  }
})
...
router.get('/:year/:quarter/:duty/allCommand', async function (req, res, next) {
  try {
    ...
    console.log('api/graphData/officerInjury/:year/:quarter/:duty/allCommand')
  } catch (error) {
    next(error)
  }
})
...
router.get('/:year/:quarter/:duty/:command', async function (req, res, next) {
  try {
    ...
    console.log('api/graphData/officerInjury/:year/:quarter/:duty/:command')
  } catch (error) {
    next(error)
  }
})
